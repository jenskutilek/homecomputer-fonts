...
<details>
<summary><b>[192] Workbench[BLED,SCAN].ttf</b></summary>
<details>
...
b'objc[43827]: Objective-C garbage collection is no longer supported.\n' [code: stderr]
...
* 🔥 **FAIL** First line in license file does not match expected format: "copyright 2008-2021, the homecomputer project authors (https://github.com/jenskutilek/homecomputer-fonts)"
...
"Copyright 2008-2021, The Homecomputer Project Authors (https://github.com/jenskutilek/homecomputer-fonts)" [code: bad-notice-format]
...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 202, but got 128 instead. [code: descent]
...
* 🔥 **FAIL** The following glyphs have components which themselves are component glyphs:
	...
	* Atilde
	* Eacute
	* Eacute and 114 more. [code: found-nested-components]
...
* 🍞 **PASS** fonts/variable/Workbench[BLED,SCAN].ttf is named canonically.
...
* 🍞 **PASS** OS/2 VendorID 'JENS' looks good!
...
* 🍞 **PASS** Font em size is good (unitsPerEm = 1024).
...
* 🍞 **PASS** The unitsPerEm value (1024) on the 'head' table is reasonable.
...
<details>
<summary><b>[192] Sixtyfour[BLED,SCAN].ttf</b></summary>
<details>
<summary>💔 <b>ERROR:</b> Checking with ftxvalidator.</summary>
...
* 💔 **ERROR** Failed with InvalidFileException: Invalid file
* ⚠ **WARN** stderr output from ftxvalidator:
b'objc[43836]: Objective-C garbage collection is no longer supported.\n' [code: stderr]
...
* 🍞 **PASS** fonts/variable/Sixtyfour[BLED,SCAN].ttf is named canonically.
